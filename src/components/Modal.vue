...
import CovenantsqlAccountModal from './modals/providers/CovenantSQLAccountModal';
import CovenantsqlSaveModal from './modals/providers/CovenantSQLSaveModal';
...
export default {
  components: {
    ...
    CovenantsqlAccountModal,
    CovenantsqlSaveModal,
  },
  computed: {
    ...mapGetters([
      'isSponsor',
